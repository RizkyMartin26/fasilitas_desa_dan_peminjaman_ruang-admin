...
@section('content')
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            {{-- Search + Tombol Tambah + Pagination --}}
            <div class="d-flex align-items-center gap-2">

                {{-- Form Search Nama --}}
                <form action="{{ route('fasilitas.index') }}" method="GET" class="d-flex">
                    <input type="text" name="search" class="form-control form-control-sm"
                        placeholder="Cari nama fasilitas..." value="{{ request('search') }}">
                    <button class="btn btn-secondary btn-sm ms-2" type="submit">Cari</button>
                </form>
                ...
                {{-- Pagination kecil di kanan atas --}}
                <div>
