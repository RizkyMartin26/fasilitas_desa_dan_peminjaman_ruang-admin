<div class="app-topstrip py-3 px-4 d-lg-flex align-items-center justify-content-between"
    ...
    <div class="d-flex align-items-center gap-4">
        ...
        <div class="d-none d-xl-flex align-items-center gap-2">
            ...
            <a href="{{ route('fasilitas.index') }}" class="btn btn-sm px-3 py-1 text-white disabled-menu" aria-disabled="true">
                <i class="ti ti-building-community fs-5"></i>
                Fasilitas
            </a>

            <a href="{{ route('peminjaman.index') }}" class="btn btn-sm px-3 py-1 text-white disabled-menu" aria-disabled="true">
