                ...
                <div class="dev-grid">
                    ...
                    <div class="dev-card">
                        <div class="dev-card-header">
                            ...
                            <div class="dev-avatar-img">
                                <img src="{{ asset('assets/images/rizky.jpg') }}" alt="Rizky Martin Pasaribu"
                                    onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                <div class="dev-avatar green fallback">RM</div>
                            </div>
                    ...
                    <div class="dev-card">
                        <div class="dev-card-header">
                            ...
                            <div class="dev-avatar-img">
                                <img src="{{ asset('assets/images/tiara.jpg') }}" alt="Tiara Kania Noer Riska"
                                    onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                <div class="dev-avatar blue fallback">TK</div>
                            </div>
                        ...
                        <div class="dev-card-body">
                            <ul>
                                <li><strong>NIM</strong> : 2457301146</li>
                                <li><strong>Jurusan</strong> : Sistem Informasi</li>
                            </ul>
